...
API_TOKEN = 'xxx'
differential_diff_search = 'https://cr-test.test.com/api/differential.query'
user_query = 'https://cr-test.test.com/api/user.query'
project_query = 'https://cr-test.test.com/api/project.query'
...
def process_transaction(revision_id, transaction_id):
    ...
    data['limit'] = 99999
    result = requests.post('https://cr-test.test.com/api/transaction.search',
